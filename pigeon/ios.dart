...
abstract final class PigeonHostApi {
  ...
  void tagReaderSessionBegin({required List<PigeonPollingOption> pollingOptions, required String? alertMessage, required bool invalidateAfterFirstRead});
  ...
  @async Uint8List iso15693ReadSingleBlock({required String handle, required List<PigeonISO15693RequestFlag> requestFlags, required int blockNumber});
  @async void iso15693WriteSingleBlock({required String handle, required List<PigeonISO15693RequestFlag> requestFlags, required int blockNumber, required Uint8List dataBlock});
  @async void iso15693LockBlock({required String handle, required List<PigeonISO15693RequestFlag> requestFlags, required int blockNumber});
  @async List<Uint8List> iso15693ReadMultipleBlocks({required String handle, required List<PigeonISO15693RequestFlag> requestFlags, required int blockNumber, required int numberOfBlocks});
  @async void iso15693WriteMultipleBlocks({required String handle, required List<PigeonISO15693RequestFlag> requestFlags, required int blockNumber, required int numberOfBlocks, required List<Uint8List> dataBlocks});
  @async void iso15693Select({required String handle, required List<PigeonISO15693RequestFlag> requestFlags});
  @async void iso15693ResetToReady({required String handle, required List<PigeonISO15693RequestFlag> requestFlags});
  @async void iso15693WriteAfi({required String handle, required List<PigeonISO15693RequestFlag> requestFlags, required int afi});
  @async void iso15693LockAfi({required String handle, required List<PigeonISO15693RequestFlag> requestFlags});
  @async void iso15693WriteDsfId({required String handle, required List<PigeonISO15693RequestFlag> requestFlags, required int dsfId});
  @async void iso15693LockDsfId({required String handle, required List<PigeonISO15693RequestFlag> requestFlags});
  @async PigeonISO15693SystemInfo iso15693GetSystemInfo({required String handle, required List<PigeonISO15693RequestFlag> requestFlags});
  @async List<int> iso15693GetMultipleBlockSecurityStatus({required String handle, required List<PigeonISO15693RequestFlag> requestFlags, required int blockNumber, required int numberOfBlocks});
  @async Uint8List iso15693CustomCommand({required String handle, required List<PigeonISO15693RequestFlag> requestFlags, required int customCommandCode, required Uint8List customRequestParameters});
}
